...
class TestAutoDiff(unittest.TestCase):
    def test_identity(self):
        ...
        self.assertIsInstance(y, ad.Node)
        self.assertTrue(np.array_equal(y_val, x2_val))
        self.assertTrue(np.array_equal(grad_x2_val, np.ones_like(x2_val)))
    ...
    def test_add_by_const(self):
        ...
        self.assertIsInstance(y, ad.Node)
        self.assertTrue(np.array_equal(y_val, x2_val + 5))
        self.assertTrue(np.array_equal(grad_x2_val, np.ones_like(x2_val)))
    ...
    def test_mul_by_const(self):
        ...
        self.assertIsInstance(y, ad.Node)
        self.assertTrue(np.array_equal(y_val, x2_val * 5))
        self.assertTrue(np.array_equal(grad_x2_val, np.ones_like(x2_val) * 5))
    ...
    def test_add_two_vars(self):
        ...
        self.assertIsInstance(y, ad.Node)
        self.assertTrue(np.array_equal(y_val, x2_val + x3_val))
        self.assertTrue(np.array_equal(grad_x2_val, np.ones_like(x2_val)))
        self.assertTrue(np.array_equal(grad_x3_val, np.ones_like(x3_val)))
    ...
    def test_mul_two_vars(self):
        ...
        self.assertIsInstance(y, ad.Node)
        self.assertTrue(np.array_equal(y_val, x2_val * x3_val))
        self.assertTrue(np.array_equal(grad_x2_val, x3_val))
        self.assertTrue(np.array_equal(grad_x3_val, x2_val))
    ...
    def test_add_mul_mix_1(self):
        ...
        self.assertIsInstance(y, ad.Node)
        self.assertTrue(np.array_equal(y_val, x1_val + x2_val * x3_val))
        self.assertTrue(
            np.array_equal(grad_x1_val, np.ones_like(x1_val) + x2_val * x3_val)
        )
        self.assertTrue(np.array_equal(grad_x2_val, x3_val * x1_val))
        self.assertTrue(np.array_equal(grad_x3_val, x2_val * x1_val))
    ...
    def test_add_mul_mix_2(self):
        ...
        self.assertIsInstance(y, ad.Node)
        self.assertTrue(np.array_equal(y_val, x1_val + x2_val * x3_val * x4_val))
        self.assertTrue(np.array_equal(grad_x1_val, np.ones_like(x1_val)))
        self.assertTrue(np.array_equal(grad_x2_val, x3_val * x4_val))
        self.assertTrue(np.array_equal(grad_x3_val, x2_val * x4_val))
        self.assertTrue(np.array_equal(grad_x4_val, x2_val * x3_val))
    ...
    def test_add_mul_mix_3(self):
        ...
        expected_grad_x2_val = (
            2 * (x2_val * x2_val + x2_val + x3_val + 3) * (2 * x2_val + 1)
        )
    ...
    def test_grad_of_grad(self):
        ...
        self.assertTrue(np.array_equal(grad_x2_val, expected_grad_x2_val))
        self.assertTrue(np.array_equal(grad_x3_val, expected_grad_x3_val))
        self.assertTrue(np.array_equal(grad_x2_x2_val, expected_grad_x2_x2_val))
        self.assertTrue(np.array_equal(grad_x2_x3_val, expected_grad_x2_x3_val))
